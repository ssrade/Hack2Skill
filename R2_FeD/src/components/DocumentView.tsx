				...
				<AnimatePresence mode="wait">
					<div className="flex-1 overflow-hidden">
						...
						<TabsContent value="risks" className="m-0 px-6" asChild>
							<motion.div key="risks" variants={tabContentVariants} initial="hidden" animate="visible" exit="exit" className="flex flex-col md:flex-row w-full h-auto">
						...
						<TabsContent value="clauses" className="m-0 px-6" asChild>
							<motion.div key="clauses" variants={tabContentVariants} initial="hidden" animate="visible" exit="exit" className="flex flex-col md:flex-row w-full h-auto">
								<div className="flex-1 h-auto md:h-[87vh] w-full pt-2 md:pr-5">
									<motion.div className="max-w-full" variants={containerVariants} initial="hidden" animate="visible">
						...
						<TabsContent value="chat" className="h-auto m-0" asChild>
							<motion.div key="chat" variants={tabContentVariants} initial="hidden" animate="visible" exit="exit" className="h-auto flex flex-col md:flex-row">
								<ChatInterface documentId={document.id} documentName={document.name} chatHistory={document.chatHistory || []} onSendMessage={onSendMessage} />
								{isDesktop && <DocumentExtrasSidebar document={document} />}
							</motion.div>
						</TabsContent>
					</div>
				</AnimatePresence>
